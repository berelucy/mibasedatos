...
public class DAOContacto {
    ...
    public List<Contacto> getAll() {
        ...
        Cursor c = _sqlitedatabase.query(MiDB.TABLE_NAME_CONTACTOS, MiDB.COLUMNS_CONTACTOS, null, null, null, null, null);

        if (c.moveToFirst()) {
            lst = new ArrayList<Contacto>();
            do {
                Contacto ctc = new Contacto(c.getInt(0),
                        c.getString(1),
                        c.getString(2),
                        c.getString(3)  );
                lst.add(ctc);
    ...
    public Cursor getAllCursor() {
        ...
        Cursor c = _sqlitedatabase.
                query(MiDB.TABLE_NAME_CONTACTOS, MiDB.COLUMNS_CONTACTOS, null, null, null, null, null);
